...
public static void buy(String name,String symbol,int amount,String file) throws JsonGenerationException, JsonMappingException, IOException
	...
	FileWriter fr = new FileWriter(file);
	fr.write("[]"+"[]");
		LinkedList<CompanyShare> company = mapper.readValue(new File("/home/admin1/Desktop/JavaPrograms/Week4JavaPrograms/company.json"), new TypeReference<LinkedList<CompanyShare>>(){});
          LinkedList<User> user = mapper.readValue(new File("/home/admin1/Desktop/JavaPrograms/Week4JavaPrograms/user.json"), new TypeReference<LinkedList<User>>(){});
