...
class AddressBookManager  implements manager {
	...
	File file = new File("//home/admin1/Desktop/JavaPrograms/Week4JavaPrograms/"+name+".json");
	...
	public static void addPersonInAddressBook(String addressBook,String firstName,String lastName) throws JsonGenerationException, JsonMappingException, IOException {
		...
		if(new File("/home/admin1/Desktop/JavaPrograms/Week4JavaPrograms/"+addressBook+".json").exists()==false)
		{
		...
		if(choice == 1)
		{
			long landline =(long) Utility.getLong();
